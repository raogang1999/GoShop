...
type GoodsClient interface {
	...
	// 获取批量商品信息
	BatchGetGoods(ctx context.Context, in *BatchGetGoodsInfo, opts ...grpc.CallOption) (*GoodsListResponse, error)
	// 商品的CRUD
	...
	CreateCategoryBrand(ctx context.Context, in *CategoryBrandRequest, opts ...grpc.CallOption) (*CategoryBriefInfoResponse, error)
...
func (c *goodsClient) BatchGetGoods(ctx context.Context, in *BatchGetGoodsInfo, opts ...grpc.CallOption) (*GoodsListResponse, error) {
	out := new(GoodsListResponse)
...
func (c *goodsClient) CreateCategoryBrand(ctx context.Context, in *CategoryBrandRequest, opts ...grpc.CallOption) (*CategoryBriefInfoResponse, error) {
	out := new(CategoryBriefInfoResponse)
...
type GoodsServer interface {
	...
	// 获取批量商品信息
	BatchGetGoods(context.Context, *BatchGetGoodsInfo) (*GoodsListResponse, error)
	// 商品的CRUD
	...
	CreateCategoryBrand(context.Context, *CategoryBrandRequest) (*CategoryBriefInfoResponse, error)
...
func (UnimplementedGoodsServer) BatchGetGoods(context.Context, *BatchGetGoodsInfo) (*GoodsListResponse, error) {
...
func (UnimplementedGoodsServer) CreateCategoryBrand(context.Context, *CategoryBrandRequest) (*CategoryBriefInfoResponse, error) {
...
func _Goods_BatchGetGoods_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).BatchGetGoods(ctx, req.(*BatchGetGoodsInfo))
	}
	return interceptor(ctx, in, info, handler)
}
