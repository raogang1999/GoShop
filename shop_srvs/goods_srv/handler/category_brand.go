...
func (s *GoodsServer) CategoryBrandList(ctx context.Context, req *proto.CategoryBrandFilterRequest) (*proto.CategoryBrandListResponse, error) {
	...
	var categoryResponses []*proto.CategoryBrandInfoResponse
	for _, categoryBrand := range categoryBrands {
		categoryResponses = append(categoryResponses, &proto.CategoryBrandInfoResponse{
...
func (s *GoodsServer) CreateCategoryBrand(ctx context.Context, req *proto.CategoryBrandRequest) (*proto.CategoryBriefInfoResponse, error) {
	var category model.Category
	...
	var categoryBriefInfoResponse proto.CategoryBriefInfoResponse
	categoryBriefInfoResponse.Id = categoryBrand.ID
	return &categoryBriefInfoResponse, nil
}
